...
function ContactForm({ onSubmitOrder }) {
  ...
  return (
    <section id="contacto" className="contact-section">
      <div className="section-grid">
        <div><h2>Solicita información</h2><p>Este sitio funciona como tienda demostrativa para recibir solicitudes de compra, cotización o contacto institucional.</p><div className="contact-list"><span><Phone /> 981 204 6664</span><span><Mail /> contacto@kiinaqua.mx</span><span><MapPin /> San Francisco de Campeche, Campeche</span></div><a href={`https://wa.me/529812046664?text=${whatsappText}`} target="_blank" rel="noreferrer"><Button>Contactar por WhatsApp</Button></a></div>
